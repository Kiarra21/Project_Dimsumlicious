            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="text-center">
                        <div
                            class="w-24 h-24 bg-primary rounded-full flex items-center justify-center text-white font-bold text-3xl mx-auto mb-4">
                        ...
                        <div class="mt-4 pt-4 border-t border-gray-200">
                            <div class="text-left space-y-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-800 font-medium">{{ $user->created_at->format('d M Y') }}
                                    </p>
                                </div>
                            </div>
                        </div>
