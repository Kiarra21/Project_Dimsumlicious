...
<head>
    ...
    <title>Register - Dimsumlicious</title>
        ...
        <div class="w-full max-w-md space-y-8">
            ...
            <div class="text-center">
                ...
                <p class="mt-2 text-sm text-gray-600">
                    Bergabunglah dengan Dimsumlicious dan nikmati kelezatan dimsum autentik
                </p>
            </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <button type="button" onclick="togglePassword('password_confirmation')"
                                class="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer hover:text-primary transition-colors duration-300">
                                <svg id="eye-icon-password_confirmation" class="h-5 w-5 text-gray-400" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <svg id="eye-slash-icon-password_confirmation" class="h-5 w-5 text-gray-400 hidden"
