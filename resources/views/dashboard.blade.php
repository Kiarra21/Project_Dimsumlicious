                ...
                <div class="flex flex-col items-center space-y-3">
                    ...
                    <div class="px-4">
                        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 break-words">
                            Selamat datang, <span class="text-primary">{{ $username ?? 'Pengguna' }}</span>!
                        </h1>
                        <p class="text-sm sm:text-base text-gray-600 mt-2">
                            Dimsumlicious siap melayani Anda.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 card-hover">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <div class="flex space-x-2">
                        <button class="px-3 py-1 bg-primary text-white rounded-full text-sm hover:bg-secondary transition-colors duration-300">
                            Bulanan
                        </button>
                        <button class="px-3 py-1 bg-gray-200 text-gray-700 rounded-full text-sm hover:bg-gray-300 transition-colors duration-300">
                            Mingguan
                        </button>
                    </div>
                </div>
                    ...
                    @foreach($chartData['labels'] as $index => $label)
                        <div class="flex flex-col items-center space-y-2">
                            <div class="flex flex-col space-y-1">
                                <div class="w-5 sm:w-6 md:w-8 bg-primary rounded-t" style="height: {{ $chartData['datasets'][0]['data'][$index] }}px;"></div>
                                <div class="w-5 sm:w-6 md:w-8 bg-secondary rounded-t" style="height: {{ $chartData['datasets'][1]['data'][$index] }}px;"></div>
                            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 card-hover">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="{{ route('pengelolaan', ['username' => $username]) }}" class="text-primary hover:text-secondary text-sm font-medium transition-colors duration-300">
                        Lihat Semua
                    </a>
                </div>
                ...
                <div class="space-y-3 sm:space-y-4">
                    ...
                    <div class="flex items-start space-x-3 p-3 rounded-lg hover:bg-gray-50 transition-colors duration-300">
                        <div class="flex-shrink-0">
