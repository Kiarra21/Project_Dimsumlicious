...
<div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-8 bg-white py-8 px-6 shadow-xl rounded-2xl border border-accent card-hover">
                <form class="space-y-6" action="{{ route('login.process') }}" method="POST">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <a href="#" class="font-medium text-primary hover:text-secondary transition-colors duration-300">
                                Lupa password?
                            </a>
                        </div>
                    </div>
                    ...
                    <div>
                        <button type="submit" 
                            ...
                            <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                                <svg class="h-5 w-5 text-white bounce-gentle" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="mt-6 p-4 bg-highlight rounded-lg border border-accent">
    ...
    <div class="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        ...
        <div class="absolute -bottom-40 -left-40 w-80 h-80 bg-secondary rounded-full opacity-20 animate-pulse" style="animation-delay: 1s;"></div>
        <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-60 h-60 bg-highlight rounded-full opacity-10 animate-pulse" style="animation-delay: 2s;"></div>
    </div>
