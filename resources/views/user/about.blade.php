                        ...
                        <div class="text-center text-white">
                            ...
                            @if ($companyProfile->logo)
                                <img src="{{ asset('storage/' . $companyProfile->logo) }}"
                                    class="w-48 h-48 mx-auto mb-4 drop-shadow-2xl object-contain"
                                    alt="Company Logo">
                            @else
                                <div class="w-48 h-48 mx-auto mb-4 bg-white/40 rounded-full flex items-center justify-center text-white text-xl font-bold drop-shadow-2xl">
                                    LOGO
                                </div>
                            @endif
